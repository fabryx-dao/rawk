...
export class AgentRegistry {
  private tokens: Map<string, string>; // token → agent_id
  private agent_ids: Set<string>; // Set of registered agent IDs
  private agents: Map<string, Agent>; // agent_id → Agent
   ...
   */
  register(desired_agent_id?: string | null): { agent_id: string; token: string } | { error: string; message: string } {
    let agent_id: string;
